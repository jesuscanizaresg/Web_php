...
<body>
	<?php
		...
		$cad= "select * from noticias_mtb where id='".$id."'";	
		...
		$fechaFormateada = $fila['fecha'];
			echo '	
					...
					<div id="bloque_pag_aux">
								<p class="titulo_pag_aux">'.$fila['titulo'].'</p>
								...
								<p class="descripcion_pag_aux">'.$fila['cuerpo_noticia'].'</p>
